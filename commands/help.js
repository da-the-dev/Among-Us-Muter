    ...
    */
    (args, msg, client) => {
        var help = new Discord.MessageEmbed()
            ...
            .addField(`**${client.prefix}addAmongUsChannel**`, `To specify which voicechannel to mute, use this command. Create the voicechat, right click and press 'Copy' to copy this voicechats's ID. Once done, type \`${client.prefix}addAmoungUsChannel <channelid>\` in any textchat (Example: \`${client.prefix}addAmongUsChannel 123456789123456789)\`. This command can only be run by users who have Administrator permission.`)
