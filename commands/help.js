    ...
    */
    (args, msg, client) => {
        var help = new Discord.MessageEmbed()
            ...
            .addField('**Patreon**', "Love this bot? Consider [donating a few dollans on Patreon](https://www.patreon.com/da_dev) to help this project grow!")
            .addField('**DonationAlerts**', "[Or use DonationAlerts instead!](https://www.donationalerts.com/r/da_dev)")
            .setColor('#b50005')
